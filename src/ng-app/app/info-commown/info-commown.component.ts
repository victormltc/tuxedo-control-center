...
@Component({
  selector: 'app-info-commown',
  templateUrl: './info-commown.component.html',
  styleUrls: ['./info-commown.component.scss']
})
export class InfoCommownComponent implements OnInit {
